<x-guest-layout>
    <div class="mb-5 text-center">
        <h1 class="text-xl font-bold text-slate-900">Acceso interno IDEJ</h1>
        <p class="text-sm text-slate-600 mt-1">Ingresa con el usuario que te asignó Administración o Sistemas.</p>
    </div>
