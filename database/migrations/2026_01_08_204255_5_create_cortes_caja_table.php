...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('cortes_caja', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('usuario_caja_abierta_id')->nullable()->unique();
            ...
            $table->decimal('otro_reportado', 10, 2)->nullable();
            $table->decimal('total_reportado', 10, 2)->nullable();
            $table->decimal('diferencia_efectivo', 10, 2)->nullable();
            $table->decimal('diferencia_transferencia', 10, 2)->nullable();
            $table->decimal('diferencia_tarjeta', 10, 2)->nullable();
            $table->decimal('diferencia_otro', 10, 2)->nullable();
