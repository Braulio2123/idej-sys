...
<head>
    ...
    {{--
        Se usa Tailwind por CDN únicamente para el Portal Alumno.
    ...
    <main class="w-full max-w-6xl grid md:grid-cols-[1.1fr_.9fr] gap-6 items-center">
        ...
        <section class="hidden md:block text-white pr-8">
            ...
            <p class="text-blue-100 text-lg max-w-xl">
                Consulta horario, materias, avisos, calificaciones y datos del plantel desde celular o computadora.
            </p>
        </section>
        ...
        <section class="bg-white rounded-[2rem] p-6 md:p-8 shadow-2xl">
            <div class="text-center mb-7">
                ...
                <p class="text-xs uppercase tracking-[.25em] font-bold text-[#0f2a5f]">
                    IDEJ
                </p>
                ...
                <p class="text-sm text-slate-500 mt-1">
                    Ingresa con tu matrícula o correo registrado.
                </p>
            </div>
            ...
            <form method="POST" action="{{ route('portal.alumno.login.submit') }}" class="space-y-5">
                ...
                <div>
                    <label for="login" class="block text-sm font-bold text-slate-700 mb-2">
                        Matrícula o correo
                    </label>
                ...
                <button
                    type="submit"
                    class="w-full rounded-2xl bg-[#0f2a5f] py-4 text-sm font-extrabold text-white shadow-lg shadow-blue-950/20 hover:bg-[#123879] transition"
                >
                    Ingresar al portal
                </button>
            </form>
            ...
            <div class="mt-6 rounded-2xl bg-amber-50 border border-amber-100 p-4 text-xs text-amber-900">
                <strong>Acceso de prueba local:</strong>
                matrícula A001 y contraseña alumno123, después de ejecutar la migración.
            </div>
        </section>
    </main>
